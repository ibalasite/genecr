...
GENECR_DIR="$HOME/.claude/skills/genecr"   # ← 若從 .codex 改 $HOME/.codex/skills/genecr；.gemini 改 $HOME/.gemini/skills/genecr
...
> 同時升所有 host（claude + codex + gemini）：`bash "$GENECR_DIR/setup" upgrade all`
